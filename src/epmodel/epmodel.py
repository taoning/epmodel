...
#   filename:  <stdin>
#   timestamp: 2025-08-04T23:09:21+00:00
...
class Version(BaseModel):
    version_identifier: Optional[str] = 25.1
...
class WindowMaterialComplexShade(BaseModel):
    ...
    left_side_opening_multiplier: Annotated[Optional[float], Field(ge=0.0, le=1.0)] = (
        0.0
    )
    right_side_opening_multiplier: Annotated[Optional[float], Field(ge=0.0, le=1.0)] = (
        0.0
    )
...
class WindowMaterialBlind(BaseModel):
    ...
    slat_thickness: Annotated[Optional[float], Field(gt=0.0, le=0.1)] = 0.00025
    slat_angle: Annotated[Optional[float], Field(ge=0.0, le=180.0)] = 45.0
    slat_conductivity: Annotated[Optional[float], Field(gt=0.0)] = 221.0
    slat_beam_solar_transmittance: Annotated[Optional[float], Field(ge=0.0, lt=1.0)] = (
        0.0
    )
    ...
    slat_diffuse_solar_transmittance: Annotated[
        Optional[float], Field(ge=0.0, lt=1.0)
    ] = 0.0
    ...
    blind_to_glass_distance: Annotated[Optional[float], Field(ge=0.01, le=1.0)] = 0.05
    blind_top_opening_multiplier: Annotated[Optional[float], Field(ge=0.0, le=1.0)] = (
        0.5
    )
    ...
    minimum_slat_angle: Annotated[Optional[float], Field(ge=0.0, le=180.0)] = 0.0
    maximum_slat_angle: Annotated[Optional[float], Field(ge=0.0, le=180.0)] = 180.0
...
class WindowPropertyFrameAndDivider(BaseModel):
    ...
    inside_sill_solar_absorptance: Annotated[Optional[float], Field(ge=0.0, le=1.0)] = (
        0.0
    )
...
ShadingBuildingDetailed = ShadingSiteDetailed
...
class MeanRadiantTemperatureCalculationType(Enum):
    ...
    enclosure_averaged = "EnclosureAveraged"
...
class ElectricEquipment(BaseModel):
    ...
    watts_per_floor_area: Annotated[Optional[float], Field(ge=0.0)] = None
...
class GasEquipment(BaseModel):
    ...
    design_level: Annotated[Optional[float], Field(ge=0.0)] = None
    power_per_floor_area: Annotated[Optional[float], Field(ge=0.0)] = None
...
class OtherEquipment(BaseModel):
    ...
    power_per_floor_area: Optional[float] = None
...
class DaylightingControls(BaseModel):
    ...
    minimum_input_power_fraction_for_continuous_or_continuousoff_dimming_control: (
        Annotated[Optional[float], Field(ge=0.0, le=0.6)]
    ) = (0.3)
    ...
    glare_calculation_azimuth_angle_of_view_direction_clockwise_from_zone_y_axis: (
        Annotated[Optional[float], Field(ge=0.0, le=360.0)]
    ) = (0.0)
...
class ZoneInfiltrationDesignFlowRate(BaseModel):
    ...
    flow_rate_per_exterior_surface_area: Annotated[Optional[float], Field(ge=0.0)] = (
        None
    )
    ...
    density_basis: Optional[DensityBasis] = DensityBasis.outdoor
...
class AirflowNetworkMultiZoneSurfaceEffectiveLeakageArea(BaseModel):
    ...
    discharge_coefficient: Annotated[Optional[float], Field(gt=0.0)] = 1.0
    reference_pressure_difference: Annotated[Optional[float], Field(gt=0.0)] = 4.0
    air_mass_flow_exponent: Annotated[Optional[float], Field(ge=0.5, le=1.0)] = 0.65
...
class DesignSpecificationOutdoorAir(BaseModel):
    ...
    outdoor_air_flow_per_zone_floor_area: Annotated[Optional[float], Field(ge=0.0)] = (
        0.0
    )
    outdoor_air_flow_per_zone: Annotated[Optional[float], Field(ge=0.0)] = 0.0
    outdoor_air_flow_air_changes_per_hour: Annotated[Optional[float], Field(ge=0.0)] = (
        0.0
    )
...
class DesignSpecificationZoneAirDistribution(BaseModel):
    ...
    zone_secondary_recirculation_fraction: Annotated[Optional[float], Field(ge=0.0)] = (
        0.0
    )
...
class TypeOfSpaceSumToUse(Enum):
...
class SizingPlant(BaseModel):
    ...
    sizing_option: Optional[TypeOfSpaceSumToUse] = TypeOfSpaceSumToUse.non_coincident
...
ThermostatSetpointSingleCooling = ThermostatSetpointSingleHeating
...
class ZoneHvacEnergyRecoveryVentilator(BaseModel):
    ...
    ventilation_rate_per_unit_floor_area: Annotated[Optional[float], Field(ge=0.0)] = (
        None
    )
...
class AirTerminalSingleDuctVavReheat(BaseModel):
    ...
    minimum_hot_water_or_steam_flow_rate: Annotated[Optional[float], Field(ge=0.0)] = (
        0.0
    )
    air_outlet_node_name: str
...
class SpeedFraction(BaseModel):
    ...
    speed_electric_power_fraction: Annotated[Optional[float], Field(ge=0.0, le=1.0)] = (
        None
    )
...
class FanSystemModel(BaseModel):
    ...
    motor_in_air_stream_fraction: Annotated[Optional[float], Field(ge=0.0, le=1.0)] = (
        1.0
    )
    ...
    motor_loss_radiative_fraction: Annotated[Optional[float], Field(ge=0.0, le=1.0)] = (
        None
    )
    end_use_subcategory: Optional[str] = "General"
...
class CoilCoolingWater(BaseModel):
    ...
    design_water_temperature_difference: Annotated[Optional[float], Field(gt=0.0)] = (
        None
    )
...
class CoilCoolingWaterToAirHeatPumpEquationFit(BaseModel):
    ...
    ratio_of_initial_moisture_evaporation_rate_and_steady_state_latent_capacity: (
        Annotated[Optional[float], Field(ge=0.0, le=5.0)]
    ) = (0.0)
...
class PumpVariableSpeed(BaseModel):
    ...
    skin_loss_radiative_fraction: Annotated[Optional[float], Field(ge=0.0, le=1.0)] = (
        None
    )
...
class BoilerHotWater(BaseModel):
    ...
    nominal_thermal_efficiency: Annotated[float, Field(gt=0.0)]
...
class CondenserFlowControl(Enum):
    constant_flow = "ConstantFlow"
    modulated_chiller_plr = "ModulatedChillerPLR"
    modulated_delta_temperature = "ModulatedDeltaTemperature"
    modulated_loop_plr = "ModulatedLoopPLR"
...
class ChillerElectricEir(BaseModel):
    ...
    end_use_subcategory: Optional[str] = "General"
    condenser_flow_control: Optional[CondenserFlowControl] = (
        CondenserFlowControl.constant_flow
    )
    condenser_loop_flow_rate_fraction_function_of_loop_part_load_ratio_curve_name: (
        Optional[str]
    ) = (None)
    temperature_difference_across_condenser_schedule_name: Optional[str] = None
    condenser_minimum_flow_fraction: Annotated[
        Optional[float], Field(ge=0.0, le=1.0)
    ] = 0.2
    thermosiphon_capacity_fraction_curve_name: Optional[str] = None
...
class CoolingTowerSingleSpeed(BaseModel):
    ...
    cell_maximum_water_flow_rate_fraction: Annotated[Optional[float], Field(ge=1.0)] = (
        2.5
    )
    sizing_factor: Annotated[Optional[float], Field(gt=0.0)] = 1.0
    end_use_subcategory: Optional[str] = "General"
...
class EvaporativeFluidCoolerTwoSpeed(BaseModel):
    ...
    outdoor_air_inlet_node_name: Optional[str] = None
    heat_rejection_capacity_and_nominal_capacity_sizing_ratio: Optional[float] = 1.25
    high_speed_standard_design_capacity: Annotated[Optional[float], Field(gt=0.0)] = (
        None
    )
...
class WaterHeaterMixed(BaseModel):
    ...
    heater_thermal_efficiency: Annotated[float, Field(gt=0.0)]
    ...
    indirect_water_heating_recovery_time: Annotated[Optional[float], Field(gt=0.0)] = (
        1.5
    )
...
SetpointManagerSingleZoneHeating = SetpointManagerSingleZoneReheat


SetpointManagerSingleZoneCooling = SetpointManagerSingleZoneReheat
...
SetpointManagerSingleZoneHumidityMaximum = SetpointManagerSingleZoneHumidityMinimum
...
class RefrigerationAirChiller(BaseModel):
    ...
    maximum_temperature_difference_between_inlet_air_and_evaporating_temperature: (
        Annotated[Optional[float], Field(ge=0.0, le=25.0)]
    ) = (None)
...
class ArrayGeometryType(Enum):
    surface = "Surface"
    tilt_azimuth = "TiltAzimuth"


class GeneratorPvWatts(BaseModel):
    pvwatts_version: Optional[Literal["5"]] = None
    dc_system_capacity: Annotated[float, Field(gt=0.0)]
    module_type: ModuleType
    array_type: ArrayType
    system_losses: Annotated[Optional[float], Field(ge=0.0, le=1.0)] = 0.14
    array_geometry_type: Optional[ArrayGeometryType] = ArrayGeometryType.tilt_azimuth
    tilt_angle: Annotated[Optional[float], Field(ge=0.0, le=90.0)] = 20.0
    azimuth_angle: Annotated[Optional[float], Field(ge=0.0, lt=360.0)] = 180.0
    surface_name: Optional[str] = None
    ground_coverage_ratio: Annotated[Optional[float], Field(ge=0.0, le=1.0)] = 0.4


class ElectricLoadCenterInverterPvWatts(BaseModel):
    dc_to_ac_size_ratio: Annotated[Optional[float], Field(gt=0.0)] = 1.1
    inverter_efficiency: Annotated[Optional[float], Field(gt=0.0, le=1.0)] = 0.96


class GeneratorObjectType(Enum):
    generator_combustion_turbine = "Generator:CombustionTurbine"
    generator_fuel_cell = "Generator:FuelCell"
    generator_internal_combustion_engine = "Generator:InternalCombustionEngine"
    generator_micro_chp = "Generator:MicroCHP"
    generator_micro_turbine = "Generator:MicroTurbine"
    generator_pv_watts = "Generator:PVWatts"
    generator_photovoltaic = "Generator:Photovoltaic"
    generator_wind_turbine = "Generator:WindTurbine"


class GeneratorOutput(BaseModel):
    generator_name: str
    generator_object_type: GeneratorObjectType
    generator_rated_electric_power_output: Optional[float] = None
    generator_availability_schedule_name: Optional[str] = None
    generator_rated_thermal_to_electrical_power_ratio: Optional[float] = None


class ElectricLoadCenterGenerators(BaseModel):
    generator_outputs: Optional[List[GeneratorOutput]] = None


class ElectricLoadCenterInverterSimple(BaseModel):
    availability_schedule_name: Optional[str] = None
    zone_name: Optional[str] = None
    radiative_fraction: Annotated[Optional[float], Field(ge=0.0, le=1.0)] = None
    inverter_efficiency: Annotated[Optional[float], Field(ge=0.0, le=1.0)] = None


class ElectricLoadCenterStorageSimple(BaseModel):
    availability_schedule_name: Optional[str] = None
    zone_name: Optional[str] = None
    radiative_fraction_for_zone_heat_gains: Annotated[
        Optional[float], Field(ge=0.0, le=1.0)
    ] = None
    nominal_energetic_efficiency_for_charging: Annotated[
        Optional[float], Field(ge=0.001, le=1.0)
    ] = None
    nominal_discharging_energetic_efficiency: Annotated[
        Optional[float], Field(ge=0.001, le=1.0)
    ] = None
    maximum_storage_capacity: Optional[float] = None
    maximum_power_for_discharging: Optional[float] = None
    maximum_power_for_charging: Optional[float] = None
...
class GeneratorOperationSchemeType(Enum):
    baseload = "Baseload"
    demand_limit = "DemandLimit"
    follow_thermal = "FollowThermal"
    follow_thermal_limit_electrical = "FollowThermalLimitElectrical"
    track_electrical = "TrackElectrical"
    track_meter = "TrackMeter"
    track_schedule = "TrackSchedule"


class ElectricalBussType(Enum):
    alternating_current = "AlternatingCurrent"
    alternating_current_with_storage = "AlternatingCurrentWithStorage"
    direct_current_with_inverter = "DirectCurrentWithInverter"
    direct_current_with_inverter_ac_storage = "DirectCurrentWithInverterACStorage"
    direct_current_with_inverter_dc_storage = "DirectCurrentWithInverterDCStorage"


class StorageOperationScheme(Enum):
    facility_demand_leveling = "FacilityDemandLeveling"
    track_charge_discharge_schedules = "TrackChargeDischargeSchedules"
    track_facility_electric_demand_store_excess_on_site = (
        "TrackFacilityElectricDemandStoreExcessOnSite"
    )
    track_meter_demand_store_excess_on_site = "TrackMeterDemandStoreExcessOnSite"


class ElectricLoadCenterDistribution(BaseModel):
    generator_list_name: Optional[str] = None
    generator_operation_scheme_type: Optional[GeneratorOperationSchemeType] = None
    generator_demand_limit_scheme_purchased_electric_demand_limit: Optional[float] = (
        None
    )
    generator_track_schedule_name_scheme_schedule_name: Optional[str] = None
    generator_track_meter_scheme_meter_name: Optional[str] = None
    electrical_buss_type: Optional[ElectricalBussType] = (
        ElectricalBussType.alternating_current
    )
    inverter_name: Optional[str] = None
    electrical_storage_object_name: Optional[str] = None
    transformer_object_name: Optional[str] = None
    storage_operation_scheme: Optional[StorageOperationScheme] = (
        StorageOperationScheme.track_facility_electric_demand_store_excess_on_site
    )
    storage_control_track_meter_name: Optional[str] = None
    storage_converter_object_name: Optional[str] = None
    maximum_storage_state_of_charge_fraction: Optional[float] = 1.0
    minimum_storage_state_of_charge_fraction: Optional[float] = 0.0
    design_storage_control_charge_power: Optional[float] = None
    storage_charge_power_fraction_schedule_name: Optional[str] = None
    design_storage_control_discharge_power: Optional[float] = None
    storage_discharge_power_fraction_schedule_name: Optional[str] = None
    storage_control_utility_demand_target: Optional[float] = None
    storage_control_utility_demand_target_fraction_schedule_name: Optional[str] = None


class PowerConversionEfficiencyMethod(Enum):
    function_of_power = "FunctionOfPower"
    simple_fixed = "SimpleFixed"


class ElectricLoadCenterStorageConverter(BaseModel):
    availability_schedule_name: Optional[str] = None
    power_conversion_efficiency_method: Optional[PowerConversionEfficiencyMethod] = (
        PowerConversionEfficiencyMethod.simple_fixed
    )
    simple_fixed_efficiency: Annotated[Optional[float], Field(gt=0.0, le=1.0)] = 0.95
    design_maximum_continuous_input_power: Optional[float] = None
    efficiency_function_of_power_curve_name: Optional[str] = None
    ancillary_power_consumed_in_standby: Optional[float] = None
    zone_name: Optional[str] = None
    radiative_fraction: Annotated[Optional[float], Field(ge=0.0, le=1.0)] = None
...
class UnitConversion(Enum):
    ...
    inch_pound_except_electricity = "InchPoundExceptElectricity"
    jto_gj = "JtoGJ"
    jto_kwh = "JtoKWH"
    jto_mj = "JtoMJ"
    none = "None"
...
OutputMeterMeterFileOnly = OutputMeter
...
class SiteLocation(BaseModel):
    ...
    keep_site_location_information: Optional[EPBoolean] = EPBoolean.no
...
class SizingPeriodDesignDay(BaseModel):
    ...
    barometric_pressure: Annotated[Optional[float], Field(ge=31000.0, le=120000.0)] = (
        None
    )
...
class WindowShadingControl(BaseModel):
    zone_name: str
    shading_control_sequence_number: Annotated[Optional[int], Field(ge=1)] = 1
...
class People(BaseModel):
    ...
    ] = MeanRadiantTemperatureCalculationType.enclosure_averaged
...
class SizingZone(BaseModel):
    ...
    type_of_space_sum_to_use: Optional[TypeOfSpaceSumToUse] = (
        TypeOfSpaceSumToUse.coincident
    )
...
class SizingSystem(BaseModel):
    ...
    type_of_zone_sum_to_use: Optional[TypeOfSpaceSumToUse] = (
        TypeOfSpaceSumToUse.non_coincident
    )
...
class ZoneHvacPackagedTerminalAirConditioner(BaseModel):
    ...
    no_load_supply_air_flow_rate_control_set_to_low_speed: Optional[EPBoolean] = (
        EPBoolean.no
    )
...
class ZoneHvacEnergyRecoveryVentilatorController(BaseModel):
    ...
    high_humidity_outdoor_air_flow_ratio: Annotated[Optional[float], Field(gt=0.0)] = (
        1.0
    )
...
class CoilCoolingDxMultiSpeed(BaseModel):
    ...
    speed_1_maximum_cycling_rate: Annotated[Optional[float], Field(ge=0.0, le=5.0)] = (
        0.0
    )
    ...
    speed_2_maximum_cycling_rate: Annotated[Optional[float], Field(ge=0.0, le=5.0)] = (
        0.0
    )
    ...
    speed_3_maximum_cycling_rate: Annotated[Optional[float], Field(ge=0.0, le=5.0)] = (
        0.0
    )
    ...
    speed_4_maximum_cycling_rate: Annotated[Optional[float], Field(ge=0.0, le=5.0)] = (
        0.0
    )
...
class HeatExchangerAirToAirSensibleAndLatent(BaseModel):
    ...
    initial_defrost_time_fraction: Annotated[Optional[float], Field(ge=0.0, le=1.0)] = (
        0.083
    )
    ...
    sensible_effectiveness_of_heating_air_flow_curve_name: Optional[str] = None
    latent_effectiveness_of_heating_air_flow_curve_name: Optional[str] = None
    sensible_effectiveness_of_cooling_air_flow_curve_name: Optional[str] = None
    latent_effectiveness_of_cooling_air_flow_curve_name: Optional[str] = None
...
class AirLoopHvacUnitarySystem(BaseModel):
    ...
    no_load_supply_air_flow_rate_per_unit_of_capacity_during_cooling_operation: (
        Annotated[Optional[float], Field(ge=0.0)]
    ) = (None)
    ...
    design_heat_recovery_water_flow_rate: Annotated[Optional[float], Field(ge=0.0)] = (
        0.0
    )
...
class ElectricLoadCenterTransformer(BaseModel):
    ...
    full_load_temperature_rise: Annotated[Optional[float], Field(ge=50.0, le=180.0)] = (
        150.0
    )
...
class OutputControlFiles(BaseModel):
    ...
    output_space_sizing: Optional[EPBoolean] = EPBoolean.no
...
class EnergyPlusModel(BaseModel):
    ...
    run_period: Annotated[Optional[Dict[str, RunPeriod]], Field(alias="RunPeriod")] = (
        None
    )
    ...
    window_material_blind: Annotated[
        Optional[Dict[str, WindowMaterialBlind]], Field(alias="WindowMaterial:Blind")
    ] = None
    ...
    zone_group: Annotated[Optional[Dict[str, ZoneGroup]], Field(alias="ZoneGroup")] = (
        None
    )
    ...
    window_shading_control: Annotated[
        Optional[Dict[str, WindowShadingControl]], Field(alias="WindowShadingControl")
    ] = None
    ...
    airflow_network_multi_zone_surface_effective_leakage_area: Annotated[
        ...
        Field(alias="AirflowNetwork:MultiZone:Surface:EffectiveLeakageArea"),
    ] = None
    ...
    fan_on_off: Annotated[Optional[Dict[str, FanOnOff]], Field(alias="Fan:OnOff")] = (
        None
    )
    ...
    plant_loop: Annotated[Optional[Dict[str, PlantLoop]], Field(alias="PlantLoop")] = (
        None
    )
    ...
    generator_pv_watts: Annotated[
        Optional[Dict[str, GeneratorPvWatts]], Field(alias="Generator:PVWatts")
    ] = None
    electric_load_center_inverter_pv_watts: Annotated[
        Optional[Dict[str, ElectricLoadCenterInverterPvWatts]],
        Field(alias="ElectricLoadCenter:Inverter:PVWatts"),
    ] = None
    electric_load_center_generators: Annotated[
        Optional[Dict[str, ElectricLoadCenterGenerators]],
        Field(alias="ElectricLoadCenter:Generators"),
    ] = None
    electric_load_center_inverter_simple: Annotated[
        Optional[Dict[str, ElectricLoadCenterInverterSimple]],
        Field(alias="ElectricLoadCenter:Inverter:Simple"),
    ] = None
    electric_load_center_storage_simple: Annotated[
        Optional[Dict[str, ElectricLoadCenterStorageSimple]],
        Field(alias="ElectricLoadCenter:Storage:Simple"),
    ] = None
    ...
    electric_load_center_distribution: Annotated[
        Optional[Dict[str, ElectricLoadCenterDistribution]],
        Field(alias="ElectricLoadCenter:Distribution"),
    ] = None
    electric_load_center_storage_converter: Annotated[
        Optional[Dict[str, ElectricLoadCenterStorageConverter]],
        Field(alias="ElectricLoadCenter:Storage:Converter"),
    ] = None
    ...
    output_json: Annotated[
        Optional[Dict[str, OutputJson]], Field(alias="Output:JSON")
    ] = None
